...
const StylistCard = ({ barber }: { barber: Barber }) => {
  return (
    <div className="group relative bg-[#1a2a3a]/60 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-transparent hover:border-[#d4af37]/50">
      ...
      <div className="absolute bottom-0 left-0 p-6 text-white">
        ...
        <p className="text-[#a0a0a0] transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 delay-300">{barber.specialty}</p>
        ...
        <a href={barber.social.instagram} target="_blank" rel="noopener noreferrer" className="absolute bottom-6 right-6 text-white hover:text-[#d4af37] scale-0 group-hover:scale-100 transition-transform duration-300 delay-500">
          <Instagram size={24} />
        </a>
      </div>
    </div>
  ...
  return (
    <section className="bg-[#0f1419] py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-white mb-12">Meet Our Stylists</h2>
